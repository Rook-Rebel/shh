...
export default function FeaturedVideo({ video }: { video: Video }) {
  ...
  return (
    <div className="relative">
      {/* Spotify-style "now playing" wash: a huge, heavily blurred, low-opacity
          copy of the thumbnail itself, bleeding out behind the card. No color
          extraction needed — the blur does the work of finding its "feeling." */}
      {video.thumbnail_url && (
        <div
          aria-hidden
          className="pointer-events-none absolute -inset-10 -z-10 opacity-20 blur-[80px] sm:-inset-16 sm:blur-[100px]"
          style={{
